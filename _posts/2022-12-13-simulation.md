...
title: Simulations- Unit 3 Section 16 Lesson Hacks
toc: true
comments: true
permalink: /simulations
categories: [lesson8]
nb_path: _notebooks/2022-12-13-simulation.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-12-13-simulation.ipynb
-->
...
<p>we should simulate the chances of netherlands winning the world cup because it is zero.</p>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>The code describes a dice rolling situation where the user is prompted to enter the number of dice they want to roll. The input is then parsed to ensure that it is a number from 1 to 6, after which the dice are rolled using the random module's randint function. The result of the dice roll is printed to the user.</p>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>i changed the number 6 to 14 because it will have more digits to chose from.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>a simulation takes a real-life process and converts it into code.
an advantage of a simulation is that it can save money and/or time</li>
<li>a disadvantage of a simulation is that it can sometimes easier to do the IRL thing than code it.</li>
<li>Yes, I think a simulation to predict that chances of the Netherlands winning the next world cup and the dice simulation would be better than waiting 4 years to see the results. </li>
</ul>
